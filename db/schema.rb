...
ActiveRecord::Schema.define(version: 2020_01_14_222000) do
  ...
  create_table "vocab_items", force: :cascade do |t|
    ...
    t.bigint "language_id"
    t.bigint "user_id"
    t.index ["language_id"], name: "index_vocab_items_on_language_id"
    t.index ["user_id"], name: "index_vocab_items_on_user_id"
  end
  ...
  add_foreign_key "vocab_items", "languages"
  add_foreign_key "vocab_items", "users"
end
